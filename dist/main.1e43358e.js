...
Dep.prototype.notify = function notify() {
  ...
  if ("dev" !== 'production' && !config.async) {
...
function set(target, key, val) {
  if ("dev" !== 'production' && (isUndef(target) || isPrimitive(target))) {
...
function validateProp(key, propOptions, propsData, vm) {
  ...
  if ("dev" !== 'production' && // skip validation for weex recycle-list child component props
  !false) {
...
function bindDynamicKeys(baseObj, values) {
  for (var i = 0; i < values.length; i += 2) {
    ...
    } else if ("dev" !== 'production' && key !== '' && key !== null) {
...
function _createElement(context, tag, data, children, normalizationType) {
  ...
  if (typeof tag === 'string') {
    ...
    if (config.isReservedTag(tag)) {
      ...
      if ("dev" !== 'production' && isDef(data) && isDef(data.nativeOn)) {
...
function renderMixin(Vue) {
  ...
  Vue.prototype._render = function () {
    ...
    try {
      ...
      if ("dev" !== 'production' && vm.$options.renderError) {
        try {
      ...
      if (isPromise(res)) {
        ...
        if (isDef(res.timeout)) {
          timerTimeout = setTimeout(function () {
            ...
            if (isUndef(factory.resolved)) {
              reject("dev" !== 'production' ? "timeout (" + res.timeout + "ms)" : null);
            }
          }, res.timeout);
        }
      }
...
var Watcher = function Watcher(vm, expOrFn, cb, options, isRenderWatcher) {
  ...
  this.expression = "dev" !== 'production' ? expOrFn.toString() : ''; // parse expression for getter
...
function Vue(options) {
  if ("dev" !== 'production' && !(this instanceof Vue)) {
...
if (inBrowser) {
  setTimeout(function () {
    if (config.devtools) {
      ...
      } else if ("dev" !== 'production' && "dev" !== 'test') {
        console[console.info ? 'info' : 'log']('Download the Vue Devtools extension for a better development experience:\n' + 'https://github.com/vuejs/vue-devtools');
      }
    }

    if ("dev" !== 'production' && "dev" !== 'test' && config.productionTip !== false && typeof console !== 'undefined') {
...
},{}],"src/components/Gif.vue":[function(require,module,exports) {
"use strict";
...
var _default = {
  ...
  mounted: function mounted() {
    ...
    fetch("https://placekitten.com/100/100").then(function (response) {
...
exports.default = _default;
        var $bd029b = exports.default || module.exports;
      
      if (typeof $bd029b === 'function') {
        $bd029b = $bd029b.options;
      }
    
        /* template */
        Object.assign($bd029b, (function () {
          var render = function() {
  var _vm = this
  ...
  return _vm.isDev()
    ? _c("div", [
        _c("div", { staticClass: "dev" }),
        _vm._v(" "),
        _c("h1", [_vm._v("dev mode")])
      ])
    : _c("div", [
        _c("img", { attrs: { src: "", alt: "Kitten" } }),
        _vm._v(" "),
        _c("h1", [_vm._v("prod mode")])
      ])
}
var staticRenderFns = []
    ...
    (function () {
      if (module.hot) {
        ...
        if (api.compatible) {
          module.hot.accept();
          if (!module.hot.data) {
            api.createRecord('$bd029b', $bd029b);
          } else {
            api.reload('$bd029b', $bd029b);
          }
        }
...
var _Gif = _interopRequireDefault(require("./components/Gif.vue"));
...
exports.default = _default;
        var $b65eb2 = exports.default || module.exports;
      
      if (typeof $b65eb2 === 'function') {
        $b65eb2 = $b65eb2.options;
      }
    
        /* template */
        Object.assign($b65eb2, (function () {
          var render = function() {
  var _vm = this
  var _h = _vm.$createElement
  var _c = _vm._self._c || _h
    ...
    (function () {
      if (module.hot) {
        ...
        if (api.compatible) {
          module.hot.accept();
          if (!module.hot.data) {
            api.createRecord('$b65eb2', $b65eb2);
          } else {
            api.reload('$b65eb2', $b65eb2);
          }
        }
...
},{"./components/Gif.vue":"src/components/Gif.vue","_css_loader":"node_modules/parcel-bundler/src/builtins/css-loader.js","vue-hot-reload-api":"node_modules/vue-hot-reload-api/dist/index.js","vue":"node_modules/vue/dist/vue.runtime.esm.js"}],"src/main.js":[function(require,module,exports) {
"use strict";
